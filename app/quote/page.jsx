    ...
    emailjs
      ...
      .then(
        (result) => {
          ...
          // You can add any success message or redirect logic here
        },
        (error) => {
                ...
                <div className="mb-3">
                  <div className="flex items-center mb-2">
                    <Form.Check
                      ...
                      onChange={handleChange}
                    />
                    <Form.Label htmlFor="thickness-2cm" className="radio-label">
                      2 cm
                    </Form.Label>
                  </div>
                  <div className="flex items-center">
                    <Form.Check
                      ...
                      onChange={handleChange}
                    />
                    <Form.Label htmlFor="thickness-3cm" className="radio-label">
                      3 cm
                    </Form.Label>
                  </div>
                </div>
